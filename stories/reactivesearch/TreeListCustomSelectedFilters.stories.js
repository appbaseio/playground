...
class TreeListCustomSelectedFilters extends Component {
	render() {
		return (
			<ReactiveBase
																...
																(pathItem, pathItemIndex) => (
																	<span
																		onClick={() => {
																			...
																			if (JSON.stringify(newValueArray) === JSON.stringify(valueArray)) {
																				return;
																			}
																			setValue(
																				component,
																	...
																	>
																		<span style={{textDecoration:'underline', color:'blue', cursor:'pointer'}} >{pathItem}</span>{' '}
																		{pathItemIndex
																		!== pathParts.length - 1 ? (
																				<span
																				style={{
...
export default TreeListCustomSelectedFilters;
