...
storiesOf('Base components/ReactiveComponent', module)
	...
	.add('with onData', () => <ReactiveComponentStory onData={action('Data Changed')} />)
	.add('With distinctField prop', () => <ReactiveComponentWithDistinctFieldProp />);
...
storiesOf('Map Components/GeoDistanceSlider', module)
	...
	.add('Playground with Google Map', () => (
		<GeoDistanceSliderGoogleMap
			defaultValue={{
				location: 'London',
				distance: 5,
	...
	.add('Playground with OpenStreet Map', () => (
...
storiesOf('Map Components/ReactiveGoogleMap', module)
	...
	.add('Basic', () => <ReactiveGoogleMapDefault />)
	...
	.add('With showSearchAsMove', () => (
		<ReactiveGoogleMapDefault showSearchAsMove={boolean('showSearchAsMove', true)} />
	))
	.add('With searchAsMove', () => (
		<ReactiveGoogleMapDefault searchAsMove={boolean('searchAsMove', false)} />
	))
	.add('With loader', () => <ReactiveGoogleMapDefault loader={text('loader', 'Loading ...')} />)
	.add('With showMapStyles', () => (
		<ReactiveGoogleMapDefault showMapStyles={boolean('showMapStyles', true)} />
	))
	.add('With defaultMapStyle', () => (
		<ReactiveGoogleMapDefault
	...
	.add('With size', () => <ReactiveGoogleMapDefault size={number('size', 100)} />)
	.add('With defaultZoom', () => (
		<ReactiveGoogleMapDefault defaultZoom={number('defaultZoom', 13)} />
	))
	.add('With onError', () => <ReactiveGoogleMapDefault onError={action('onError')} />)
	.add('With renderError', () => (
		<ReactiveGoogleMapDefault
...
storiesOf('Map Components/ReactiveOpenStreetMap', module)
	...
	.add('Basic', () => <ReactiveOpenStreetMapDefault />)
	.add('With autoCenter', () => (
		<ReactiveOpenStreetMapDefault autoCenter={boolean('autoCenter', true)} />
	))
	.add('With loader', () => (
		<ReactiveOpenStreetMapDefault loader={text('loader', 'Loading ...')} />
	))
	.add('With onError', () => <ReactiveOpenStreetMapDefault onError={action('onError')} />)
	.add('With renderError', () => (
		<ReactiveOpenStreetMapDefault
			renderError={() => <div style={{ color: 'red' }}>Something went wrong!</div>}
		/>
	))
	.add('With size', () => <ReactiveOpenStreetMapDefault size={number('size', 100)} />)
	.add('With showSearchAsMove', () => (
		<ReactiveOpenStreetMapDefault showSearchAsMove={boolean('showSearchAsMove', true)} />
	))
	.add('With searchAsMove', () => (
		<ReactiveOpenStreetMapDefault searchAsMove={boolean('searchAsMove', false)} />
	))
	.add('With defaultZoom', () => (
...
storiesOf('Range components/DynamicRangeSlider', module)
	...
	.add('Basic', () => <DynamicRangeSliderDefault />)
	.add('With title', () => <DynamicRangeSliderDefault title={text('title', 'Books')} />)
	.add('With labels', () => (
	...
	.add('With custom stepValue', () => (
		<DynamicRangeSliderDefault stepValue={number('stepValue', 1)} />
	))
	.add('Without histogram', () => (
		<DynamicRangeSliderDefault showHistogram={boolean('showHistogram', false)} />
	))
	.add('With filters', () => (
	...
	.add('With tooltipTrigger', () => (
		<DynamicRangeSliderDefault tooltipTrigger={text('tooltipTrigger', 'always')} />
	))
	.add('With loader', () => <DynamicRangeSliderDefault loader="Loading..." />)
	.add('Playground', () => (
		<DynamicRangeSliderDefault
...
storiesOf('Base components/TagCloud', module)
	...
	.add('Basic', () => <TagCloudDefault />)
	.add('With title', () => <TagCloudDefault title={text('title', 'Cities')} />)
	.add('With showCount', () => <TagCloudDefault showCount={boolean('showCount', true)} />)
	.add('With custom filter', () => (
		<TagCloudDefault
			showFilter={boolean('showFilter', true)}
			filterLabel={text('filterLabel', 'Cities filter')}
		/>
	))
	.add('With multiSelect', () => <TagCloudDefault multiSelect={boolean('multiSelect', true)} />)
	.add('With defaultValue', () => <TagCloudDefault defaultValue={['Auckland']} />)
	.add('With multiSelect on and defaultValue', () => (
		<TagCloudDefault multiSelect defaultValue={['Auckland', 'Amsterdam']} />
	))
	.add('With multiSelect off and defaultValue', () => (
		<TagCloudDefault defaultValue={['Auckland']} />
	))
	.add('With sortBy', () => <TagCloudDefault sortBy={select('sortBy', ['asc', 'desc'], 'asc')} />)
	.add('With URLParams', () => (
		<TagCloudDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('With loader', () => <TagCloudDefault loader="Loading..." />)
	.add('Playground', () => (
		<TagCloudDefault
...
storiesOf('Range components/RatingsFilter', module)
	...
	.add('Basic', () => <RatingsFilterDefault />)
	.add('With title', () => <RatingsFilterDefault title={text('title', 'Ratings')} />)
	.add('With defaultValue', () => <RatingsFilterDefault defaultValue={{ start: 2, end: 5 }} />)
	.add('With URLParams', () => (
		<RatingsFilterDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('Playground', () => (
...
storiesOf('Search components/CategorySearch', module)
	...
	.add('Basic', () => <CategorySearchDefault placeholder="Search Books by Author" />)
	.add('With title', () => (
	...
	.add('with custom suggestions icon', () => (
		<CategorySearchDefault
			placeholder="Search Books..."
	...
	.add('With Weights', () => <CategorySearchDefault weights={array('weights', [1, 3])} />)
	.add('With fuzziness', () => <CategorySearchDefault fuzziness={number('fuzziness', 1)} />)
	...
	.add('With enablePopularSuggestions', () => <CategorySearchDefault enablePopularSuggestions />)
	.add('With renderPopularSuggestions', () => (
		<CategorySearchDefault
			enablePopularSuggestions
	...
	.add('With addonBefore prop', () => <CategorySearchDefault addonBefore={<h3> Before</h3>} />)
	.add('With addonAfter prop', () => <CategorySearchDefault addonAfter={<h3> After</h3>} />)
	.add('With addonBefore & addonAfter prop', () => (
		<CategorySearchDefault addonBefore={<h3> Before</h3>} addonAfter={<h3> After</h3>} />
	))
	.add('With expandSuggestionsContainer prop', () => (
		<CategorySearchDefault
...
storiesOf('Result components/ReactiveList', module)
	...
	.add('With infinite loading', () => <ReactiveListDefault pagination={false} />)
	.add('With scrollTarget', () => (
		<ReactiveListDefault
			pagination={false}
	...
	.add('With onQueryChange', () => (
		<ReactiveListDefault onQueryChange={action('Query Changed')} />
	))
	.add('With onData', () => <ReactiveListDefault onData={action('Data Changed')} />)
...
storiesOf('Result components/ResultCard', module)
	...
	.add('Basic', () => <ResultCardDefault />)
	.add('With size', () => <ResultCardDefault size={number('size', 12)} />)
	.add('Hide resultStats', () => (
		<ResultCardDefault showResultStats={boolean('showResultStats', false)} />
	))
	.add('With infinite loading', () => <ResultCardDefault pagination={false} />)
	.add('With pagination', () => (
		<ResultCardDefault
			pagination={boolean('pagination', true)}
	...
	.add('With onQueryChange', () => <ResultCardDefault onQueryChange={action('Query Changed')} />)
	.add('With Sort Options', () => (
		<ResultCardDefault
			sortOptions={[
				{
	...
	.add('With onData', () => <ResultCardDefault onData={action('Data Changed')} />)
	.add('Playground', () => (
		<ResultCardDefault
			size={number('size', 12)}
			dataField={select(
...
storiesOf('Result components/ResultList', module)
	...
	.add('Basic', () => <ResultListDefault />)
	.add('With size', () => <ResultListDefault size={text('size', 5)} />)
	.add('Hide resultStats', () => (
		<ResultListDefault showResultStats={boolean('showResultStats', false)} />
	))
	.add('With infinite loading', () => <ResultListDefault size={10} pagination={false} />)
	.add('With pagination', () => (
		<ResultListDefault
			pagination={boolean('pagination', true)}
			paginationAt={text('paginationAt', 'bottom')}
	...
	.add('With onQueryChange', () => <ResultListDefault onQueryChange={action('Query Changed')} />)
	.add('With Sort Options', () => (
		<ResultListDefault
			sortOptions={[
				{
...
storiesOf('Search components/DataSearch', module)
	...
	.add('Basic', () => <DataSearchRSDefault placeholder="Search Books..." />)
	.add('With title', () => (
		<DataSearchRSDefault title={text('title', 'Books Search')} placeholder="Search Books..." />
	))
	.add('wihout search icon', () => (
		<DataSearchRSDefault placeholder="Search Books..." showIcon={boolean('showIcon', false)} />
	))
	.add('with iconPosition', () => (
		<DataSearchRSDefault
			placeholder="Search Books..."
	...
	.add('with showClear', () => (
		<DataSearchRSDefault placeholder="Search Books..." showClear={boolean('showClear', true)} />
	))
	.add('with custom clearIcon', () => (
		<DataSearchRSDefault
			placeholder="Search Books..."
	...
	.add('with debounce', () => (
		<DataSearchRSDefault placeholder="Search Books..." debounce={number('debounce', 300)} />
	))
	.add('With strictSelection', () => (
		<DataSearchRSDefault
			placeholder="Search Books..."
	...
	.add('With custom renderer', () => (
		<DataSearchRSDefault
			placeholder="Search Books..."
			render={({ value, data, downshiftProps: { isOpen, getItemProps, highlightedIndex } }) =>
				isOpen &&
				Boolean(value.length) && (
					<div
						style={{
	...
	.add('With defaultValue', () => (
		<DataSearchRSDefault placeholder="Search Books..." defaultValue="Harry Potter" />
	))
	.add('With defaultSuggestions', () => (
		<DataSearchRSDefault
			placeholder="Search Books..."
	...
	.add('With fuzziness as a number', () => (
		<DataSearchRSDefault placeholder="Search Books..." fuzziness={number('fuzziness', 1)} />
	))
	.add('With fuzziness as AUTO', () => (
		<DataSearchRSDefault placeholder="Search Books..." fuzziness="AUTO" />
	))
	.add('With highlight', () => (
		<DataSearchRSDefault placeholder="Search Books..." highlight={boolean('highlight', true)} />
	))
	.add('With queryFormat', () => (
		<DataSearchRSDefault
			placeholder="Search Books..."
	...
	.add('With loader', () => (
		<DataSearchRSDefault placeholder="Search Books..." loader="Loading suggestions..." />
	))
	.add('With enablePopularSuggestions', () => <DataSearchRSDefault enablePopularSuggestions />)
	.add('With renderPopularSuggestions', () => (
		<DataSearchRSDefault
			enablePopularSuggestions
			renderPopularSuggestions={({
	...
	.add('With addonBefore prop', () => <DataSearchRSDefault addonBefore={<h3> Before</h3>} />)
	.add('With addonAfter prop', () => <DataSearchRSDefault addonAfter={<h3> After</h3>} />)
	.add('With addonBefore & addonAfter prop', () => (
		<DataSearchRSDefault addonBefore={<h3> Before</h3>} addonAfter={<h3> After</h3>} />
	))
	.add('With expandSuggestionsContainer prop', () => (
		<DataSearchRSDefault
			addonBefore={<h3>Before</h3>}
...
storiesOf('List components/SingleList', module)
	...
	.add('Basic', () => <SingleListRSDefault showSearch placeholder="Search Books" />)
	.add('With title', () => (
		<SingleListRSDefault
			showSearch
			placeholder="Search Books"
	...
	.add('With size', () => (
		<SingleListRSDefault showSearch placeholder="Search Books" size={number('size', 10)} />
	))
	.add('Without count', () => (
		<SingleListRSDefault
			showSearch
	...
	.add('With custom renderer', () => (
		<SingleListRSDefault showSearch placeholder="Search Books">
			{({ data, handleChange }) =>
				data.map(item => (
					<div onClick={() => handleChange(item.key)}>
						{item.key}
						<span style={{ marginLeft: 5, color: 'dodgerblue' }}>{item.doc_count}</span>
					</div>
				))
			}
		</SingleListRSDefault>
	...
	.add('Without Search', () => (
		<SingleListRSDefault showSearch={boolean('showSearch', false)} placeholder="Search Books" />
	))
	.add('With filter', () => (
		<SingleListRSDefault
			showSearch
	...
	.add('Custom Sort', () => (
		<SingleListRSDefault
			...
			showSearch
			sortBy={select('sortBy', { asc: 'asc', desc: 'desc', count: 'count' }, 'asc')}
			placeholder="Search Books"
		/>
	))
	.add('With Select All', () => (
	...
	.add('With loader', () => (
		<SingleListRSDefault showSearch placeholder="Search Books" loader="Loading..." />
	))
	.add('extending onValueChange', () => (
		<SingleListRSDefault
			showSearch
			placeholder="Search Books"
	...
	.add('With enableStrictSelection', () => (
		<SingleListRSDefault showSearch placeholder="Search Books" enableStrictSelection />
	))
	.add('Playground', () => (
		<SingleListRSDefault
...
storiesOf('List components/MultiList', module)
	...
	.add('Basic', () => <MultiListRSDefault showSearch placeholder="Search Books" />)
	.add('With title', () => (
		<MultiListRSDefault
			showSearch
			placeholder="Search Books"
	...
	.add('With size', () => (
		<MultiListRSDefault showSearch placeholder="Search Books" size={number('size', 10)} />
	))
	.add('With filter', () => (
		<MultiListRSDefault
			showSearch
	...
	.add('With custom renderer', () => (
		<MultiListRSDefault showSearch placeholder="Search Books">
			{({ data, handleChange }) =>
				data.map(item => (
					<div onClick={() => handleChange(item.key)}>
						{item.key}
	...
	.add('Without Search', () => (
		<MultiListRSDefault showSearch={boolean('showSearch', false)} placeholder="Search Books" />
	))
	...
	.add('extending with onValueChange', () => (
		<MultiListRSDefault
			showSearch
			placeholder="Search Books"
	...
	.add('with loader', () => (
		<MultiListRSDefault showSearch placeholder="Search Books" loader="Loading..." />
	))
	.add('Playground', () => (
		<MultiListRSDefault
			title={text('title', 'MultiList: Books Filter')}
			...
			size={number('size', 10)}
			sortBy={select('sortBy', { asc: 'asc', desc: 'desc', count: 'count' }, 'count')}
			defaultValue={['Harry Potter', 'Artemis Fowl']}
			showCount={boolean('showCount', true)}
			showSearch={boolean('showSearch', true)}
...
storiesOf('List components/SingleDropdownList', module)
	...
	.add('Basic', () => <SingleDropdownListRSDefault />)
	.add('With title', () => <SingleDropdownListRSDefault title={text('title', 'Book list')} />)
	.add('With size', () => <SingleDropdownListRSDefault size={number('size', 10)} />)
	.add('With filter', () => (
	...
	.add('Without count', () => (
		<SingleDropdownListRSDefault showCount={boolean('showCount', false)} />
	))
	.add('With search', () => (
		<SingleDropdownListRSDefault showSearch={boolean('showSearch', true)} />
	))
	.add('With renderItem', () => (
		<SingleDropdownListRSDefault
			renderItem={(label, count) => (
	...
	.add('With Select All', () => (
		<SingleDropdownListRSDefault selectAllLabel={text('selectAllLabel', 'All Books')} />
	))
	.add('With Default Selected', () => (
		<SingleDropdownListRSDefault selectAllLabel="All Cities" defaultValue="A Beautiful Dark" />
	))
	.add('With URLParams', () => (
		<SingleDropdownListRSDefault
			URLParams={boolean('URLParams (not visible on storybook)', true)}
	...
	.add('With loader', () => <SingleDropdownListRSDefault loader="Loading..." />)
	.add('Playground', () => (
		<SingleDropdownListRSDefault
...
storiesOf('List components/MultiDropdownList', module)
	...
	.add('Basic', () => <MultiDropdownListRSDefault />)
	.add('With title', () => <MultiDropdownListRSDefault title={text('title', 'Books list')} />)
	.add('With Placeholder', () => (
		<MultiDropdownListRSDefault placeholder={text('placeholder', 'Select Books')} />
	))
	.add('With size', () => <MultiDropdownListRSDefault size={number('size', 10)} />)
	.add('With filter', () => (
	...
	.add('Without count', () => (
		<MultiDropdownListRSDefault showCount={boolean('showCount', false)} />
	))
	.add('With search', () => (
		<MultiDropdownListRSDefault showSearch={boolean('showSearch', true)} />
	))
	.add('With custom sort', () => (
		<MultiDropdownListRSDefault
			sortBy={select('sortBy', { asc: 'asc', desc: 'desc', count: 'count' }, 'asc')}
	...
	.add('with loader', () => <MultiDropdownListRSDefault loader="Loading..." />)
	.add('extending onValueChange', () => (
		<MultiDropdownListRSDefault onValueChange={action('MultiDropdownList Value Changed')} />
	))
	.add('Playground', () => (
		<MultiDropdownListRSDefault
...
storiesOf('List components/SingleDataList', module)
	...
	.add('Basic', () => <SingleDataListRSDefault />)
	.add('With title', () => <SingleDataListRSDefault title={text('title', 'Topics')} />)
	.add('With defaultValue', () => <SingleDataListRSDefault defaultValue="Social" />)
	.add('With showSearch', () => (
	...
	.add('Without Radio', () => <SingleDataListRSDefault showRadio={boolean('showRadio', false)} />)
	.add('With selectAllLabel', () => (
		<SingleDataListRSDefault selectAllLabel={text('selectAllLabel', 'Select All')} />
	))
	.add('With filter', () => (
		<SingleDataListRSDefault
			showFilter={boolean('showFilter', true)}
	...
	.add('With count', () => <SingleDataListRSDefault showCount />)
	.add('With renderItem', () => (
		<SingleDataListRSDefault
			showCount
			renderItem={(label, count) => (
	...
	.add('With enableStrictSelection', () => <SingleDataListRSDefault enableStrictSelection />)
	.add('Playground', () => (
		<SingleDataListRSDefault
...
storiesOf('List components/MultiDataList', module)
	...
	.add('Basic', () => <MultiDataListRSDefault />)
	.add('With title', () => <MultiDataListRSDefault title={text('title', 'Topics')} />)
	.add('With defaultValue', () => <MultiDataListRSDefault defaultValue={['Social', 'Music']} />)
	.add('With showSearch', () => (
	...
	.add('Without Checkbox', () => (
		<MultiDataListRSDefault showCheckbox={boolean('showCheckbox', false)} />
	))
	.add('With selectAllLabel', () => (
		<MultiDataListRSDefault selectAllLabel={text('selectAllLabel', 'Select All')} />
	))
	.add('With filter', () => (
		<MultiDataListRSDefault
			showFilter={boolean('showFilter', true)}
	...
	.add('With count', () => <MultiDataListRSDefault showCount={boolean('With count', true)} />)
	.add('With renderItem', () => (
		<MultiDataListRSDefault
			renderItem={(label, count) => (
				<div
...
storiesOf('Range components/SingleRange', module)
	...
	.add('Basic', () => <SingleRangeRSDefault />)
	.add('With title', () => (
		<SingleRangeRSDefault title={text('title', 'SingleRange: Books Filter')} />
	))
	.add('With Default Selected', () => <SingleRangeRSDefault defaultValue="Rating 3 to 4" />)
	.add('With filter', () => (
	...
	.add('Without radio buttons', () => (
		<SingleRangeRSDefault showRadio={boolean('showRadio', false)} />
	))
	.add('With URLParams', () => (
		<SingleRangeRSDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('Playground', () => (
		<SingleRangeRSDefault
...
storiesOf('Range components/MultiRange', module)
	...
	.add('Basic', () => <MultiRangeRSDefault />)
	.add('With title', () => (
		<MultiRangeRSDefault title={text('title', 'MultiRange: Books Filter')} />
	))
	.add('With Default Selected', () => <MultiRangeRSDefault defaultValue={['Rating 3 to 4']} />)
	.add('With filter', () => (
		<MultiRangeRSDefault
			showFilter={boolean('showFilter', true)}
			filterLabel={text('filterLabel', 'Books filter')}
	...
	.add('Without checkbox', () => (
		<MultiRangeRSDefault showCheckbox={boolean('showCheckbox', false)} />
	))
	.add('With URLParams', () => (
		<MultiRangeRSDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('Playground', () => (
		<MultiRangeRSDefault
...
storiesOf('Range components/SingleDropdownRange', module)
	...
	.add('Basic', () => <SingleDropdownRangeRSDefault />)
	.add('With title', () => (
		<SingleDropdownRangeRSDefault title={text('title', 'SingleDropdownRange: Books Filter')} />
	))
	.add('With placeholder', () => (
		<SingleDropdownRangeRSDefault placeholder={text('placeholder', 'Search books')} />
	))
	.add('With Default Selected', () => (
		<SingleDropdownRangeRSDefault defaultValue="Rating 3 to 4" />
	))
	.add('With filter', () => (
...
storiesOf('Range components/MultiDropdownRange', module)
	...
	.add('Basic', () => <MultiDropdownRangeRSDefault />)
	.add('With title', () => (
		<MultiDropdownRangeRSDefault title={text('title', 'MultiDropdownRange: Books Filter')} />
	))
	.add('With placeholder', () => (
		<MultiDropdownRangeRSDefault placeholder={text('placeholder', 'Search books')} />
	))
	.add('With Default Selected', () => (
		<MultiDropdownRangeRSDefault defaultValue={['Rating 3 to 4']} />
	))
	.add('With filter', () => (
...
storiesOf('Base components/ToggleButton', module)
	...
	.add('Basic', () => <ToggleButtonRSDefault />)
	.add('With title', () => (
		<ToggleButtonRSDefault title={text('title', 'ToggleButton: Topics')} />
	))
	.add('With Default Selected', () => <ToggleButtonRSDefault defaultValue={['Music']} />)
	.add('With filter', () => (
	...
	.add('Without multiSelect', () => (
		<ToggleButtonRSDefault multiSelect={boolean('multiSelect', false)} />
	))
	.add('With URLParams', () => (
		<ToggleButtonRSDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('Playground', () => (
		<ToggleButtonRSDefault
...
storiesOf('Range components/DatePicker', module)
	...
	.add('Basic', () => <DatePickerRSDefault />)
	.add('With title', () => <DatePickerRSDefault title={text('title', 'Date Picker')} />)
	.add('With placeholder', () => (
		<DatePickerRSDefault placeholder={text('placeholder', 'Pick date')} />
	))
	.add('With filter', () => (
		<DatePickerRSDefault
			showFilter={boolean('showFilter', true)}
	...
	.add('With focus', () => <DatePickerRSDefault focused={boolean('focused', true)} />)
	.add('Show more than 1 month', () => (
		<DatePickerRSDefault numberOfMonths={number('numberOfMonths', 2)} />
	))
	.add('Default date', () => <DatePickerRSDefault defaultValue="2017-04-07" />)
	.add(
		'with initialMonth',
		withInfo(
	...
	.add('Without clear button', () => (
		<DatePickerRSDefault showClear={boolean('showClear', false)} />
	))
	.add('Without clickUnselectsDay', () => (
		<DatePickerRSDefault clickUnselectsDay={boolean('clickUnselectsDay', false)} />
	))
	.add('With queryFormat', () => (
		<DatePickerRSDefault
			queryFormat={select(
	...
	.add('With URLParams', () => (
		<DatePickerRSDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('Playground', () => (
		<DatePickerRSDefault
...
storiesOf('Range components/DateRange', module)
	...
	.add('Basic', () => <DateRangeRSDefault />)
	.add('With title', () => <DateRangeRSDefault title={text('title', 'Date Range')} />)
	.add('With placeholder', () => (
		<DateRangeRSDefault
	...
	.add('without showClear', () => <DateRangeRSDefault showClear={boolean('showClear', false)} />)
	.add('With filter', () => (
		<DateRangeRSDefault
			showFilter={boolean('showFilter', true)}
	...
	.add('Show more than 1 month', () => (
		<DateRangeRSDefault numberOfMonths={number('numberOfMonths', 3)} />
	))
	.add('Default date', () => (
		<DateRangeRSDefault
			defaultValue={{
	...
	.add('wihout autoFocusEnd', () => (
		<DateRangeRSDefault autoFocusEnd={boolean('autoFocusEnd', false)} />
	))
	.add('With queryFormat', () => (
		<DateRangeRSDefault
			queryFormat={select(
	...
	.add('With URLParams', () => (
		<DateRangeRSDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('Playground', () => (
		<DateRangeRSDefault
...
storiesOf('Range components/RangeInput', module)
	...
	.add('Basic', () => <RangeInputRSDefault />)
	.add('With title', () => <RangeInputRSDefault title={text('title', 'RangeInput: Ratings')} />)
	.add('With Default Selected', () => (
		<RangeInputRSDefault
			defaultValue={{
				start: 5000,
	...
	.add('Without slider', () => <RangeInputRSDefault showSlider={boolean('showSlider', false)} />)
	.add('With custom histogram interval', () => (
	...
	.add('With filters', () => <RangeInputRSDefault showFilter={boolean('showFilter', true)} />)
	.add('With onDrag', () => (
		<RangeInputRSDefault
			rangeLabels={object('rangeLabels', {
				start: 'Low',
	...
	.add('With URLParams', () => (
		<RangeInputRSDefault URLParams={boolean('URLParams (not visible on storybook)', true)} />
	))
	.add('With tooltipTrigger', () => (
		<RangeInputRSDefault tooltipTrigger={text('tooltipTrigger', 'always')} />
	))
	.add('Playground', () => (
		<RangeInputRSDefault
...
storiesOf('Range components/RangeSlider', module)
	...
	.add('Basic', () => <RangeSliderRSDefault />)
	.add('With title', () => <RangeSliderRSDefault title={text('title', 'RangeSlider: Ratings')} />)
	.add('With Default Selected', () => (
	...
	.add('With tooltipTrigger', () => (
		<RangeSliderRSDefault tooltipTrigger={text('tooltipTrigger', 'always')} />
	))
	.add('Playground', () => (
		<RangeSliderRSDefault
